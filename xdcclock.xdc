...
set_property -dict { PACKAGE_PIN M12    IOSTANDARD LVCMOS33 } [get_ports { rst  }];#LSB

set_property -dict {PACKAGE_PIN F2 IOSTANDARD LVCMOS33} [get_ports {digit_sel[3]}]
...
set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS33} [get_ports {digit_sel[0]}]
...
#set_property -dict { PACKAGE_PIN L5    IOSTANDARD LVCMOS33 } [get_ports { bcd[0] }];#LSB
#set_property -dict { PACKAGE_PIN L4    IOSTANDARD LVCMOS33 } [get_ports { bcd[1] }];
#set_property -dict { PACKAGE_PIN M4    IOSTANDARD LVCMOS33 } [get_ports { bcd[2] }];
#set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVCMOS33 } [get_ports { bcd[3] }];
#set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { bcd[4] }];
#set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { bcd[5] }];
#set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { bcd[6] }];
#set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { bcd[7] }];
#set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { bcd[8] }];
...
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin_num[9]}]
set_property PACKAGE_PIN L5 [get_ports {bin_num[0]}]
set_property PACKAGE_PIN L4 [get_ports {bin_num[1]}]
set_property PACKAGE_PIN M4 [get_ports {bin_num[2]}]
set_property PACKAGE_PIN M2 [get_ports {bin_num[3]}]
set_property PACKAGE_PIN M1 [get_ports {bin_num[4]}]
set_property PACKAGE_PIN N3 [get_ports {bin_num[5]}]
set_property PACKAGE_PIN N2 [get_ports {bin_num[6]}]
set_property PACKAGE_PIN N1 [get_ports {bin_num[7]}]
set_property PACKAGE_PIN P1 [get_ports {bin_num[8]}]
set_property PACKAGE_PIN P4 [get_ports {bin_num[9]}]
set_property PACKAGE_PIN P8 [get_ports {bin_num[10]}]
set_property PACKAGE_PIN R8 [get_ports {bin_num[11]}]
set_property PACKAGE_PIN N6 [get_ports {bin_num[12]}]
set_property PACKAGE_PIN T7 [get_ports {bin_num[13]}]
